...
module rv32i_top #(
    ...
    input logic clk,
    input logic reset,
    output logic [15:0] led      // debug: keeps the design alive
    
    );

//CPU 4-stage internal output signals:
//inputs of each stage are outputs of another stages
//signals named first as stage name means that they travel through multiple stages 
...
////////////////////////////////////////////////////////////////////////    
    ...
    //Tied off, we will test branch/jump after testing normal instructions. ex_stage will drive these.
    assign ex_if_use_target = 1'b0;
    assign ex_if_pc_target  = 32'b0;  
    assign led = id_inst.reg_file.register[4][15:0];    
